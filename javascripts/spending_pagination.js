...
var filteredSpendingDataSet = spending_data;
...
function renderTableSection() {
  ...
  var dataSubset = filteredSpendingDataSet.slice(startingIndex, endingIndex);
...
function handleLoadMoreDataClick() {
  ...
  if (startingIndex + resultsPerPage >= filteredSpendingDataSet.length) {
