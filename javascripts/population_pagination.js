...
var filteredPopulationDataSet = population_data;
...
function renderTableSection() {
  ...
  var dataSubset = filteredPopulationDataSet.slice(startingIndex, endingIndex);
...
function handleLoadMoreDataClick() {
  ...
  if (startingIndex + resultsPerPage >= filteredPopulationDataSet.length) {
